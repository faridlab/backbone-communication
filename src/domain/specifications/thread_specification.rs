//! Specifications for Thread aggregate
//!
...
// Each predicate implements `Specification<Thread>` and can be combined
...
//
// pub struct ActiveThreadSpec;
// impl Specification<Thread> for ActiveThreadSpec {
//     fn is_satisfied_by(&self, e: &Thread) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
