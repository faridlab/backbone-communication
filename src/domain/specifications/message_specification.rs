//! Specifications for Message aggregate
//!
...
// Each predicate implements `Specification<Message>` and can be combined
...
//
// pub struct ActiveMessageSpec;
// impl Specification<Message> for ActiveMessageSpec {
//     fn is_satisfied_by(&self, e: &Message) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
