...
use super::{
    message_handler::create_message_routes,
    thread_handler::create_thread_routes,
};
...
pub fn configure_routes(services: HttpServices) -> Router {
    Router::new()
        // Message routes (12 Backbone endpoints)
        .merge(create_message_routes(services.message))
        // Thread routes (12 Backbone endpoints)
        .merge(create_thread_routes(services.thread))
}
...
pub mod individual {
    ...
    pub fn message_routes(service: Arc<MessageService>) -> Router {
        create_message_routes(service)
    }

    pub fn thread_routes(service: Arc<ThreadService>) -> Router {
