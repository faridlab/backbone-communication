...
/// Create stateless routes for the Communication module.
///
...
///
/// ```ignore
/// let module = CommunicationModule::builder().with_database(pool).build()?;
/// let routes = create_stateless_routes(&module);
/// let app = Router::new().merge(routes);
/// ```
pub fn create_stateless_routes(module: &crate::CommunicationModule) -> Router<()> {
    Router::new()
...
pub fn get_routes(module: &crate::CommunicationModule) -> Router<()> {
    Router::new()
...
/// Create stateful routes for the Communication module.
///
...
pub fn create_combined_routes(module: &crate::CommunicationModule) -> Router<AppState> {
...
/// Get all routes (stateful) for the Communication module.
///
/// This is a convenience function that wraps routes with API versioning.
pub fn get_routes_with_state(module: &crate::CommunicationModule) -> Router<AppState> {
    Router::new()
